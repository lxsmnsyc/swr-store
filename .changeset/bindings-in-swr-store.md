...
The React, Preact and Solid bindings now ship inside `swr-store`, and the store API is simpler and safer. See the [migration guide](https://github.com/lxsmnsyc/swr-store/blob/main/packages/swr-store/MIGRATION.md) for how to upgrade.
