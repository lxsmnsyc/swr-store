...
function DogImage(props: BreedProps): ComponentChildren {
...
function Trigger(props: BreedProps): ComponentChildren {
  return (
    <button
      type="button"
      onClick={() => {
...
function SetBreed(props: SetBreedProps): ComponentChildren {
  return (
    <form
      onSubmit={(event) => {
...
export default function App(): ComponentChildren {
